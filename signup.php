            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <img src="img/logo.gif" align="middle"/>
                    <div class="panel-heading">
                        <h3 class="panel-title" style="color:#F00">*All fields are required</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="domemreg.php" method="post">
                            <fieldset>
                            <div class="form-group">
                                ...
                                <a href="pages/index.html" class="btn btn-lg btn-success btn-block">Sign Up</a>-->
