...
$category = $_POST['category'];
	   ...
	   $updateres = mysql_query("UPDATE `ticket` SET c_id = '$category' where ticket_code =  '$ticket_code'");
			...
			echo 
				...
				alert("YOU HAVE SUCCESSFULLY CHANGED THE CATEGORY OF TICKET:'. ($ticket_code).'\n\nThank you.")
