    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <form action="docreateadmin.php" method="post">
                        	<div class="form-group">
                              ...
                              <div class="form-group">
                                            ...
                                            <p class="help-block">New administrator's password</p>
                              </div>
                               <div class="form-group">
                                           <label>role</label>
                                            ...
                                            <p class="help-block">New administrator's role</p>
                              </div>
                              <div class="form-group">
			...
			?>
                              ...
                              <input id="Submit" name="submit" type="submit" class="btn btn-default" value="Create Admin" />
                        </form>
                        </div>
                        <!-- /.panel-body -->
                    </div>
