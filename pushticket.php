    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="dopushticket.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>push to another administrator</label>
            ...
            ?>
                                        ...
                                        <button type="submit" class="btn btn-default">Push ticket</button></button>
                                    </form>
                        </div>
                        <!-- /.panel-body -->
                    </div>
